...
Run `npx plogr-workflow` at a project root to select task, verification, and research profiles. It writes `herdr/dispatch-profile.json` and then runs `npx skills@latest add mattpocock/skills`.
