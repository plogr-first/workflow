...
description: Progressive-disclosure project knowledge retrieval Skill. Use when a workflow agent needs prior project decisions, pitfalls, case cards, architecture knowledge, or evidence from .knowledge. The embedding provider is supplied by the host project; this Skill does not install or assume a specific provider.
---
...
1. Read `herdr/dispatch-profile.json` and verify `knowledge_retrieval.enabled` and the project-provided provider contract.
