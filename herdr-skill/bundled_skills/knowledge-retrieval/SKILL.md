...
5. When a durable case is learned, add a redacted Markdown card under `.knowledge/cards/`, then rebuild the semantic index.

Read [references/provider-contract.md](references/provider-contract.md) only when configuring or troubleshooting semantic indexing.
